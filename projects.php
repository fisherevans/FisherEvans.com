<?php
    ...
    function getProjectsContent($path) {
        ...
        if($action == "") {
            ...
            $content = '<h1>Projects</h1><p>Throughout my high school experience, I won three state championships for Computer Maintenance, Inter-Networking and Web Design. I continued to compete nationally in Computer Maintenance and Inter-Networking, finishing in 38th and 13th place respectively.</p>';
